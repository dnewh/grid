...
pub(in crate::grid_db::locations) trait LocationStoreUpdateLocationOperation {
    fn update_location(
        &self,
                    ...
                    let attr = location_attribute::table
                        .filter(
                            location_attribute::location_id
                                .eq(&attribute.location_id)
                                .and(location_attribute::service_id.eq(&attribute.service_id)),
                        )
